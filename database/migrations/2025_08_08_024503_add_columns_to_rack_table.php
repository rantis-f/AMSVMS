...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('rack', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->foreign('id_fasilitas')->references('id_fasilitas')->on('listfasilitas')->onDelete('set null');
            $table->foreign('id_perangkat')->references('id_perangkat')->on('listperangkat')->onDelete('set null');
        });
    }
