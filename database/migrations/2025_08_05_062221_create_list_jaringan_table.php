...
return new class extends Migration
{
    ...
    {
        Schema::create('listjaringan', function (Blueprint $table) {
            ...
            $table->foreign('kode_tipejaringan')->references('kode_tipejaringan')->on('tipejaringan')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('listjaringan');
    }
};
